...
public class FileListCellRenderer implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(
		...
		try {
			bi = ImageIO.read(ViewLaunch.class.getResource("/react.png"));
		...
		// Selection background changes
		
		if (selected) {
			panel_right.setBackground(new Color(207, 220, 241));
			panel_left.setBackground(new Color(207, 220, 241));
		}
